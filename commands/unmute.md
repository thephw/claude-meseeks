---
description: Unmute a Mr. Meeseeks sound category (done, asking, feedback, or all)
argument-hint: [done|asking|feedback|all]
arguments: [category]
allowed-tools: Bash
disable-model-invocation: true
---
!`"${CLAUDE_PLUGIN_ROOT}"/scripts/play.sh enable "$category"`

The command above tried to unmute the given category. If the output shows an error
